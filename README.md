...
- O usuário deve poder listar horários disponíveis em 1 dia específico de um prestador;
...
- Um usuário não pode agendar em um horário já ocupado;
- O usuário não pode agendar numa data/horário no passado;
